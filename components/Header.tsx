...
const Header = () => {
    ...
    return (
        <header className='flex flex-wrap justify-between items-center px-4 py-2'>
            {/* Top row */}
            <div className='flex w-full flex-wrap justify-between item-center px-4 py-2'>
                <Link
                    href="/"
                    className='text-2xl leading-[42px] font-bold text-blue-500 hover:opacity-50 cursor-pointer mx-auto sm:mx-0'
                >
                    Shopit
                </Link>
                ...
                <div className='flex items-center space-x-4 mt-4 sm:mt-0 mx-auto flex-1 sm:flex-none'>
                    <Link
                        href="/basket"
                    ...
                    >
                        ...
                        {/* Span item count once global state is set up */}
                        <span>My Basket</span>
                    </Link>
