    ...
    return (
        <div className="flex items-center justify-center space-x-2">
            ...
            <button
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-200 ${itemCount === 0
...
export default AddOrRemoveFromBasketButton;